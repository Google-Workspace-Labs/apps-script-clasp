...
const SLACK_MSG = {
  ko: {
    ...
    user_reg_no_cpn: 'ℹ️ 활성 쿠폰 0개 — 배치 생략 (쿠폰 등록 시 일괄 발급)',
    ...
    mn_create_guide: '📖 Guide 시트 생성 (배포자 1회)',
  ...
  en: {
    ...
    user_reg_no_cpn: 'ℹ️ No active coupons — batch skipped (will issue when a coupon is added)',
    ...
    mn_create_guide: '📖 Create Guide sheet (deployer, once)',
